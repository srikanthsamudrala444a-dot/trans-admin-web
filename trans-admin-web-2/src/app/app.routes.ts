  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () => import('./features/pricing-management/pricing-management.component').then(c => c.PricingManagementComponent)
      },
      {
        path: 'fare-management',
        loadComponent: () => import('./features/fare-management/fare-management.component').then(c => c.FareManagementComponent)
      },
      {
        path: 'rewards',
      ...
      },
      {
        ...
        loadComponent: () => import('./features/financial-incentives/financial-incentives.component').then(c => c.FinancialIncentivesComponent)
      },
      {
      ...
      },
      {
        ...
        loadComponent: () => import('./features/emergency-management/emergency-management.component').then(c => c.EmergencyManagementComponent)
      },
      {
        path: 'settings',
